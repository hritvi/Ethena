...
var web3 = new Web3(new Web3.providers.HttpProvider("http://localhost:1234")); //initialize the web3 object to listen on the port testrpc is running on - so we can communicate with the blockchain
...
var code = fs.readFileSync("Prisma.sol").toString();
...
var byteCode = compiledCode.contracts[":Prisma"].bytecode;
console.log("\n------------ LOGGING BYTECODE -------------\n");
...
var abi = compiledCode.contracts[":Prisma"].interface;
console.log(
        ...
        fs.writeFile(
          ...
          function(err) {
            if (err) {
              ...
              console.log(`The file .public/balanceContract.json was saved!`);
            }
          }
        );
      }
